...
| Nombre           | CHAR(30)       | x(10)       | no nulo, único                   | N/A        | N/A             | Nombre de la actividad                       |
| descripcion      | VARCHAR(30)    | x(30)       | No nulo                          | N/A        | N/A             | Descripcion de la actividad                  |
| Costo            | Decimal(5,2)   | x99999.99   | No nulo                          | N/A        | N/A             | Cantidad de dinero gastado para la actividad |
...
| Estado_actividad | VARCHAR(20)    | x(20)       | En espera, Pendiente, completado | N/A        | N/A             | Estado en el que se encuentra la actividad   |
...
| **Atributo**    | **Naturaleza** | **Formato** | **Valores Válidos**   | **Unidad** | **Derivada de** | **Descripción (Corta)**                                  |
| --------------- | -------------- | ----------- | --------------------- | ---------- | --------------- | -------------------------------------------------------- |
| dod_Mantenimiento | SERIAL       |9999999       | >0, No nulo, único        | N/A        | N/A             | Identificador único del mantenimiento                   |
| prioridad       | CHAR(2)        | X9          | TAB1                  | N/A        | N/A             | Prioridad que tiene el mantenimiento                     |
| plazo           | DATE           | YYYY-MM-DD  | Fecha válida, no nulo | N/A        | N/A             | Fecha máxima que se tiene para realizar el mantenimiento |
| Descripción     | VARCHAR        | x(100)      | No nulo               | N/A        | N/A             | Detalles que tiene el mantenimiento                     |
| encargado        | CHAR(10)      | X(10)       | No nulo               | N/A        | N/A             | Encargado de dirigir cierto mantenimiento            |
| estado           | DEFINIDO      | DEFINIDO    | (Pendiente, Hecho)     | N/A         |  N/A             |  Estado en que se encuentra un mantenimiento programado| 
...
| **Atributo**   | **Naturaleza** | **Formato** | **Valores Válidos**   | **Unidad** | **Derivada de** | **Descripción (Corta)**               |
| -------------- | -------------- | ----------- | --------------------- | ---------- | --------------- | ------------------------------------- |
|   prioridad    |  CHAR(2)       | X9          | no null               | N/A        | N/A             | Prioridad que tiene el mantenimiento  |
|  descrip_prioridad| VARCHAR     |  X(64)      | no null               | N/A        |  N/A            | Nombre propio que posee cada prioridad |
...
| **Atributo**   | **Naturaleza** | **Formato** | **Valores Válidos**   | **Unidad** | **Derivada de** | **Descripción (Corta)**               |
| -------------- | -------------- | ----------- | --------------------- | ---------- | --------------- | ------------------------------------- |
| cod_incidencia | SERIAL       | 99999999       | >0, No nulo, único        | N/A        | N/A             | Identificador único de la incidencia  |
| fecha_hora_registro | TIMESTAMP | YYYY-MM-DD HH: MM :SS  | Fecha y hora válida, no nulo | N/A        | N/A             | Fecha y hora que se realizó el registro      |
| descripción    | VARCHAR           | x(100)       | No nulo               | N/A        | N/A             | Detalles que tiene la incidencia      |
| estado         | DEFINIDO           | DEFINIDO       | (pendiente, programado) | N/A        | N/A             | Estado de la incidencia registrada    |
...
| **Atributo**     | **Naturaleza** | **Formato** | **Valores Válidos**   | **Unidad** | **Derivada de** | **Descripción (Corta)**                                   |
| ---------------- | -------------- | ----------- | --------------------- | ---------- | --------------- | --------------------------------------------------------- |
| cod_RMantenimiento | SERIAL       | 999999999       | >0, No nulo, único        | N/A        | N/A             | Identificador único del registro de mantenimiento  |
| fecha_Realizada   | DATE           | YYYY-MM-DD  | Fecha válida, no nulo | N/A        | N/A             | Fecha que se realizó el registro                          |
| hora_inicio    | TIME           | HH: MM :SS  | Valida en tiempo, no nulo      | horas      | N/A             | Hora que se realizó el mantenimiento                          |
| hora_fin       | TIME           | HH: MM : SS | Valida en tiempo, no nulo       | horas     | N/A              | Hora en que finalizó el mantenimiento |
| Observaciones    | VARCHAR           | x(64)       | Puede ser nulo               | N/A        | N/A             | Detalles que hubieron en el mantenimiento                 |
...
| **Atributo**  | **Naturaleza** | **Formato** | **Valores Válidos**  | **Unidad** | **Derivada de** | **Descripción (Corta)**             |
| ------------- | -------------- | ----------- | -------------------- | ---------- | --------------- | ----------------------------------- |
| cod_instalacion    | CHAR(6)       | XXX999       | No nulo              | N/A        | N/A             | Código único de intalación          |
| nombre_instalacion | VARCHAR        | x(40)       | No nulo              | N/A        | N/A             | Nombre específico de la instalación |
...
| **Atributo**      | **Naturaleza** | **Formato** | **Valores Válidos**   | **Unidad** | **Derivada de** | **Descripción**                       |
| ----------------- | -------------- | ----------- | --------------------- | ---------- | --------------- | ------------------------------------- |
| id_factura         | CHAR(10)       | x(10)       | No nulo, único        | N/A        | N/A             | Identificador único de la factura.    |
| fecha_emision     | DATE           | dd/mm/aaaa  | No nulo               | N/A        | N/A             | Fecha en la que se emitió la factura. |
| monto_Total       | DECIMAL(10,2)  | 9999999.99  | No nulo, > 0          | Moneda     | N/A             | Monto total a pagar por la factura.   |
| estado_factura            | CHAR(10)       | x(10)       | "Pendiente", "Pagado" | N/A        | N/A             | Estado actual de la factura.          |
| fecha_vencimiento | DATE           | dd/mm/aaaa  | No nulo               | N/A        | N/A             | Fecha límite para pagar la factura.   |
| id_inquilino       | CHAR(10)       | x(10)       | No nulo, único        | N/A        | N/A             | Identificador único del inquilino.    |
...
| **Atributo**      | **Naturaleza** | **Formato** | **Valores Válidos**   | **Unidad** | **Derivada de** | **Descripción**                                                                      |
| ----------------- | -------------- | ----------- | --------------------- | ---------- | --------------- | ------------------------------------------------------------------------------------ |
| id_recordatorio    | CHAR(10)       | x(10)       | No nulo, único        | N/A        | N/A             | Identificador único del recordatorio.                                                |
...
| contenido         | VARCHAR(50)    | x(64)       | No nulo               | N/A        | N/A             | Mensaje o detalles específicos que se enviaron en el recordatorio.                   |
| id_factura         | CHAR(10)       | x(10)       | No nulo, único        | N/A        | N/A             | Identificador único de la factura.    |
...
| **Atributo** | **Naturaleza** | **Formato** | **Valores Válidos**       | **Unidad** | **Derivada de** | **Descripción (Corta)**                 |
| ------------ | -------------- | ----------- | ------------------------- | ---------- | --------------- | --------------------------------------- |
| id_pago       | CHAR(10)       | x(10)       | No nulo, único            | N/A        | N/A             | Identificador único del pago.           |
...
| metodo_pago  | CHAR(20)       | x(20)       | "Manual", "Automático"    | N/A        | N/A             | Método utilizado para realizar el pago. |
| tipo_moneda   | CHAR(3)        | x(3)        | "USD", "EUR", "PEN", etc. | N/A        | N/A             | Moneda en la que se realizó el pago.    |
| id_factura         | CHAR(10)       | x(10)       | No nulo, único        | N/A        | N/A             | Identificador único de la factura.    |
---
...
| **Atributo**       | **Naturaleza** | **Formato** | **Valores Válidos**   | **Unidad**            | **Derivada de** | **Descripción (Corta)**                                                      |
| ------------------ | -------------- | ----------- | --------------------- | --------------------- | --------------- | ---------------------------------------------------------------------------- |
| Área               | float          | 9999999.99  | >0                    | Metros cuadrados (m²) | N/A             | Superficie total del espacio comercial.                                      |
| Estado             | CHAR (20)      | x(10)       | TAB4                  | N/A                   | N/A             | Estado actual del espacio comercial.                                         |
| PrecioPorDia       | float          | 9999999.99  | >0                    | Moneda                | N/A             | Precio de alquilar el Espacio común por un día.                              |
