...
| **Atributo**         | **Naturaleza** | **Formato**         | **Valores Válidos**       | **Unidad** | **Derivada de** | **Descripción (Corta)**                                |
|----------------------|----------------|---------------------|---------------------------|------------|-----------------|--------------------------------------------------------|
| idEmpleado               | CHAR(10)       | x(10)               | No nulo, único             | N/A        | N/A             | Identificador único del pago.                          |
| Rol           | DATE           | dd/mm/aaaa          | No nulo                    | N/A        | N/A             | Fecha en la que se realizó el pago.                    |
| Nombres           | DECIMAL(10,2)  | 9999999.99          | No nulo, > 0               | Moneda     | N/A             | Monto pagado en esta transacción.                      |
| Apellido Paterno          | CHAR(20)       | x(20)               | "Manual", "Automático"     | N/A        | N/A             | Método utilizado par            |
| Apellido Materno          | CHAR(20)       | x(20)               | "Manual", "Automático"     | N/A        | N/A             | Método utilizado par            |
| Nacionalidad          | CHAR(20)       | x(20)               | "Manual", "Automático"     | N/A        | N/A             | Método utilizado par            |
| Documento de identidad          | CHAR(20)       | x(20)               | "Manual", "Automático"     | N/A        | N/A             | Método utilizado par            |
| Dirección          | CHAR(20)       | x(20)               | "Manual", "Automático"     | N/A        | N/A             | Método utilizado par            |
| Cargo          | CHAR(20)       | x(20)               | "Manual", "Automático"     | N/A        | N/A             | Método utilizado par            |
...
|-------------------------|----------------|-------------|---------------------------|------------|-----------------|----------------------------------------------------------------------|
| ID de Empleado       | CHAR(10) | Alfanumérico| Único por empleado         | N/A        | Generado        | Identificador único para cada empleado                               |
| Nombre             | Obligatorio    | Texto       | Nombres y Apellidos        | N/A        | Ingresado       | Nombre completo del empleado                                         |
| Fecha de Nacimiento  | Obligatorio    | Fecha       | AAAA-MM-DD                 | Años       | Ingresado       | Fecha de nacimiento del empleado                                     |
| Género            | Opcional       | Texto       | Masculino, Femenino, Otro  | N/A        | Ingresado       | Identidad de género del empleado                                     |
| Estado Civil         | Opcional       | Texto       | Soltero, Casado, Divorciado, etc. | N/A    | Ingresado       | Estado civil del empleado                                            |
| Nacionalidad         | Obligatorio    | Texto       | Países reconocidos         | N/A        | Ingresado       | Nacionalidad del empleado                                            |
| Número de Identificación | Obligatorio | Alfanumérico| Según país (DNI, Pasaporte)| N/A        | Ingresado       | Documento de identidad nacional o pasaporte                          |
| Dirección            | Opcional       | Texto       | Dirección válida           | N/A        | Ingresado       | Domicilio actual del empleado                                        |
| Teléfono             | Opcional       | Numérico    | Número de teléfono válido  | N/A        | Ingresado       | Número de contacto telefónico                                        |
| Correo Electrónico   | Opcional       | Texto       | Dirección de email válida  | N/A        | Ingresado       | Correo electrónico personal o laboral       |
 
| Cargo    | Obligatorio    | Texto       | Cargo dentro de la empresa | N/A        | Ingresado       | Título o posición que ocupa el empleado en la organización           |
| Salario              | Obligatorio    | Numérico    | Valor monetario            | Moneda     | Ingresado       | Salario base del empleado                                            |
| Fotografía           | Opcional       | Imagen      | Archivo de imagen          | N/A        | Ingresado       | Fotografía del empleado para el sistema                              |
