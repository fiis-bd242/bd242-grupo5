...
| **Atributo**       | **Naturaleza** | **Formato** | **Valores Válidos**        | **Unidad** | **Derivada de** | **Descripción (Corta)**                       |
| ------------------ | -------------- | ----------- | -------------------------- | ---------- | --------------- | --------------------------------------------- |
| Nombre_recobro     | VARCHAR(30)    | x(30)       | No nulo                    | N/A        | N/A             | Nombre del recobro                            |
...
| idinquilino        | CHAR(10)       | x(10)       | No nulo                    | N/A        | N/A             | Identificador único del inquilino             |
| Razon_recobro      | VARCHAR(30)    | x(30)       | no nulo                    | N/A        | N/A             | Motivo por el cual se realiza el recobro      |
| Categoria_recobro  | VARCHAR(100)   | x(100)      | no nulo                    | N/A        | N/A             | Clasificacion en la cual entra el recobro     |
...
| Periodos           | VARCHAR(4)     | x(4)        | No nulo                    | dias       | N/A             | Tiempos  para realizar las tareas encargadas para completar el proyecto   |
| Actividades        | VARCHAR(20)    | x(20)       | No nulo                    | N/A        | N/A             | Deberes a realizar necesarios para el proyecto                            |
| Cronograma         | CHAR(10)       | x(10)       | no nulo,                   | N/A        | N/A             | codigo para identificar el cronograma                                     |
...
| **Atributo**        | **Naturaleza** | **Formato** | **Valores Válidos**        | **Unidad** | **Derivada de** | **Descripción (Corta)**                                    |
| ------------------- | -------------- | ----------- | -------------------------- | ---------- | --------------- | -----------------------------------------------------------|
| Nombre_acuerdo      | VARCHAR(40)    | x(40)       | no nulo                    | N/A        | N/A             | nombre del acuerdo                                         |
| ID_acuerdo          | VARCHAR(30)    | x(30)       | No nulo, único             | N/A        | N/A             | Codigo para identificar el acuerdo del recobro             |
...
| encargado        | CHAR           | x(64)       | No nulo               | N/A        | N/A             | Encargado de dirigir cierto mantenimiento            |
|Estado           | CHAR            | x(50)       | Pendiente, Hecho     | N/A         |  N/A             |  Estado en que se encuentra un mantenimiento programado| 
...
| estado         | CHAR           | x(30)       | pendiente, programado | N7A        | N/A             | Estado de la incidencia registrada    |
...
| **Atributo**         | **Naturaleza** | **Formato** | **Valores Válidos**  | **Unidad** | **Derivada de** | **Descripción (Corta)**                    |
| -------------------- | -------------- | ----------- | -------------------- | ---------- | --------------- | ------------------------------------------ |
| nombre_instal        | CHAR           | x(64)       | No nulo              | N/A        | N/A             | Nombre específico de la instalación        |
...
| contenido          | TEXT           | N/A          | No nulo               | N/A        | N/A             | Mensaje o detalles específicos que se enviaron en el recordatorio.                   |
