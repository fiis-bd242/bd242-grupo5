...
| Salario              | DECIMAL(10,2)   | Númerico(10,2)| Valor monetario            | Moneda     | N/A       | Salario base del empleado                                            |
...
| **Atributo**               | **Naturaleza** | **Formato**    | **Valores Válidos**               | **Unidad**   | **Derivada de**       | **Descripción**                                              |
|----------------------------|----------------|----------------|-----------------------------------|--------------|-----------------------|--------------------------------------------------------------|
| IdContratoEmpleado          | CHAR(10)       | x(10)          | Único por contrato                | N/A          | Generado              | Identificador único para cada contrato                        |
| IdEmpleado          | CHAR(10)       | x(10)          | Relación con empleado             | N/A          | Relación (Empleado)    | Identificador del empleado asociado al contrato               |
| Fecha de Inicio         | DATE           | YYYY-MM-DD     | Fecha válida                      | Días         | Ingresado             | Fecha de inicio del contrato                                 |
| Fecha de Fin            | DATE           | YYYY-MM-DD     | Fecha válida o NULL si es indefinido | Días      | Ingresado             | Fecha de finalización del contrato, si es aplicable           |
| Salario Base           | DECIMAL(10,2)  | Numérico(10,2) | Valor monetario                   | Moneda       | Ingresado             | Salario base asociado al contrato del empleado                |
| Jornada Laboral         | VARCHAR(15)    | x(15)          | Completa, Parcial, Turno Rotativo | N/A          | Ingresado             | Tipo de jornada que cubre el contrato                         |
| Estado del Contrato     | VARCHAR(15)    | x(15)          | Activo, Finalizado, Suspendido    | N/A          | Ingresado             | Estado actual del contrato del empleado                       |
| Descripción del Cargo   | TEXT           | Texto libre    | Descripción detallada             | N/A          | Ingresado             | Descripción del cargo o responsabilidades en el contrato      |
