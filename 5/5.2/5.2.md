...
| Tipo de inmueble   | CHAR (10)      | x(10)       | TAB1                | N/A                   | N/A             | Clasificación del inmueble.                           |
| Área               | DECIMAL(10,2)  | 9999999.99  | >0                  | Metros cuadrados (m²) | N/A             | Superficie total del espacio comercial.               |
| Estado             | CHAR (10)      | x(10)       | TAB2                | N/A                   | N/A             | Estado actual del espacio comercial.                  |
...
|**Atributo** |**Naturaleza**| **Formato**  | **Valores Válidos**    | **Unidad** | **Derivada de** | **Descripción**                          |
| ----------- | ------------ | ------------ | ---------------------- | ---------- | --------------- | ------------------------------------------------ |
| nombre_zona | CHAR(100)    | x(100)      | No nulo, único          | N/A        | N/A             | Nombre de la zona que identifica su ubicación. |
| piso        | INT          | 9           | 1-9, No nulo            | N/A        | N/A             | Número del piso donde se encuentra la zona.     |
| referencia  | CHAR(256)    | x(256)      | No nulo                 | N/A        | N/A             | Descripción o referencia adicional de la zona.   |
