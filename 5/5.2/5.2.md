...
## Entidad Recobro
Contiene información sobre especifica de un servicio extra que la empresa realice para el inquilino

| **Atributo**       | **Naturaleza** | **Formato** | **Valores Válidos**        | **Unidad** | **Derivada de** | **Descripción (Corta)**                       |
| ------------------ | -------------- | ----------- | -------------------------- | ---------- | --------------- | --------------------------------------------- |
| Nombre_recobro     | VARCHAR(20)    | x(20)       | No nulo                    | N/A        | N/A             | Nombre del recobro                            |
| Descripcion_recobro| VARCHAR(99)    | x(99)       | No nulo                    | N/A        | N/A             | Detalles del recobro a realizar               |
...
| Fecha_inicio_proyecto | DATE           | YYYY-MM-DD  | Fecha válida, no nulo      | N/A        | N/A             | Fecha en la que inicia el proyecto                |
| Fecha_inicio_proyecto | DATE           | YYYY-MM-DD  | Fecha válida, no nulo      | N/A        | N/A             | Fecha en la que finaliza el pryoecto              |
| Estado_proyecto       | VARCHAR(15)    | x(15)       | Ejecutado, Finalizado      | N/A        | N/A             | Estado en el que se encuentra el proyecto         |
...
| Descripcion_acuerdo | VARCHAR(500)   | x(500)      | no nulo                    | N/A        | N/A             | Detalles sobre el acuerdo                                  |
...
| **Atributo**           | **Naturaleza** | **Formato** | **Valores Válidos**              | **Unidad** | **Derivada de** | **Descripción (Corta)**                        |
| ---------------------- | -------------- | ----------- | -------------------------------- | ---------- | --------------- | ---------------------------------------------- |
| cod_actividad          | CHAR(10)       | x(10)       | no nulo, único                   | N/A        | N/A             | Codigo para identificar a la actividad         |
| nombre_actividad       | CHAR(50)       | x(50)       | no nulo                          | N/A        | N/A             | Nombre de la actividad                         |
| descripcion            | VARCHAR(30)    | x(30)       | No nulo                          | N/A        | N/A             | Descripcion de la actividad                    |
| Fecha_inicio_actividad | DATE           | YYYY-MM-DD  | Fecha válida, no nulo            | N/A        | N/A             | Fecha en la que inicia la actividad            |
| Fecha_fin_actividad    | DATE           | YYYY-MM-DD  | Fecha válida, no nulo            | N/A        | N/A             | Fecha en la que finaliza la actividad          |
| Costo_actividad        | Decimal(5,2)   | x99999.99   | no nulo, único                   | N/A        | N/A             | Codigo para identificar a la actividad         |
| Estado_actividad       | VARCHAR(10)    | x(15)       | Ejecutado, Finalizado, En espera | N/A        | N/A             | Codigo para identificar a la actividad         |
...
| **Atributo**         | **Naturaleza** | **Formato** | **Valores Válidos**  | **Unidad** | **Derivada de** | **Descripción (Corta)**                    |
| -------------------- | -------------- | ----------- | -------------------- | ---------- | --------------- | ------------------------------------------ |
| nombre_instal        | VARCHAR         | x(40)       | No nulo              | N/A        | N/A             | Nombre específico de la instalación        |
