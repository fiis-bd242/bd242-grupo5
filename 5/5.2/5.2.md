...
|-------------------------|-----------------|--------------|---------------------------|------------|-----------------|----------------------------------------------------------------------|
| ID de Empleado       | CHAR(10)        | x(10)        | Único por empleado         | N/A        | N/A        | Identificador único para cada empleado                               |
...
| Nacionalidad         | VARCHAR(50)     | x(50)        | Países reconocidos         | N/A        | N/A       | Nacionalidad del empleado                                            |
...
| Cargo               | VARCHAR(50)     | x(50)        | Cargo dentro de la empresa | N/A        | Ingresado       | Título o posición que ocupa el empleado en la organización           |
| Salario              | DECIMAL(10,2)   | Númerico(10,2)| Valor monetario            | Moneda     | Ingresado       | Salario base del empleado                                            |
| Fotografía           | BLOB            | Archivo binario | Archivo de imagen      | N/A        | Ingresado       | Fotografía del empleado para el sistema                              |
