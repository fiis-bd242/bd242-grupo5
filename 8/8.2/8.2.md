...
### **Función Primaria**
Generar, visualizar y gestionar facturas de manera eficiente para los arrendamientos de los inquilinos en MallPlaza, garantizando un control adecuado del estado de los pagos y facilitando la emisión de recordatorios.

### **Sustentación**
La implementación de este módulo centraliza la administración de facturas y mejora los procesos de seguimiento y control de los pagos pendientes. Además, permite una interacción fluida con otras funcionalidades relacionadas, como registrar pagos y enviar recordatorios, optimizando la experiencia del usuario y reduciendo errores administrativos.
---

| **Actividad** | **Descripción** |
|---------------|------------------|
| **1** | Al ingresar a la sección "Facturación" y presionar el botón "Generar Facturas", el sistema muestra la pantalla **I-026** donde se listan las facturas generadas para los contratos activos. <br><br>![image](I026.png) |
| **2** | Cada fila de la tabla incluye información clave: número de factura, nombre del inquilino, inmueble asociado, fechas de inicio y fin del contrato, estado de la factura y monto de renta. |
| **3** | En la parte inferior, el sistema presenta un botón llamado "Enviar Facturas" que permite enviar las facturas pendientes a los arrendatarios. |
---
