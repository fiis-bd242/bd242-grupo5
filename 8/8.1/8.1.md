...
SELECT * FROM recobro_tabla
WHERE  id_recobro= <Código recobro> 
...
## Sentencias SQL
### Eventos:
* **Boton Enviar:** Cuando se selecciona los datos se registran.
...
```sql
INSERT INTO actividades (cod_actividad, nombre_actividad, descripcion, Fecha_inicio_actividad, Fecha_fin_actividad, Costo_actividad, Estado_actividad)
VALUES
(<P001>,
 <Pintado>,
 <Pintado del cartel>,
...
```sql
INSERT INTO Proyecto_recobro (cod_actividad, nombre_actividad, descripcion, Fecha_inicio_actividad, Fecha_fin_actividad, Costo_actividad, Estado_actividad, ID_proyecto_R)
VALUES
(<P001>,
 <Pintado>,
 <Pintado del cartel>,
